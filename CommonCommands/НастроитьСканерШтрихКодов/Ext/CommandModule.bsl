...
Процедура ОбработкаКоманды(ПараметрКоманды, ПараметрыВыполненияКоманды)
	...
	ФормаНастройкиТО = ПолучитьФорму("Справочник.НастройкиТорговогоОборудования.ФормаВыбора",
									Новый Структура("РежимВыбора", Истина));

	// Получим результат выбора пользователя
	ВыбранныеНастройки =  ФормаНастройкиТО.ОткрытьМодально();
