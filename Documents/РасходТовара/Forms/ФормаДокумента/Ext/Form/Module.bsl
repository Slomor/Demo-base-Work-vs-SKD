...
Процедура ОформитьДоставкуВыполнить()
	...
	ОткрытьФормуМодально("Документ.РасходТовара.Форма.ОформлениеДоставки", ПараметрыДоставки);
КонецПроцедуры
...
&НаКлиенте
Процедура НовыйПокупатель(Команда)
	ОткрытьФорму("Справочник.Контрагенты.ФормаОбъекта", , ЭтаФорма);
КонецПроцедуры
